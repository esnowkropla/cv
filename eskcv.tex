...
& \footnotesize { Designed, developed, and maintained internal web-app providing reporting, monitoring and optimization information to Media team } \\
...
Software: & \textsc{Git}, \textsc{PostgreSQL}, \textsc{Flask}, \textsc{Excel}, \textsc{LabVIEW}, \textsc{nginx} \\
\end{tabular}
